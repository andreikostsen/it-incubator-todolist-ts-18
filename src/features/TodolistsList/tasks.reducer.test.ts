...
test("title of specified task should be changed", () => {
  ...
  const action = {
    ...
    payload: {taskId: "2", model: {title: "yogurt"}, todolistId: "todolistId2"}
     ...
     // tasksActions.updateTask({ taskId: "2", model: { title: "yogurt" }, todolistId: "todolistId2" });
...
test("tasks should be added for todolist", () => {
  ...
  const action:FetchTasksActionType = {type: tasksThunks.fetchTasks.fulfilled.type,
